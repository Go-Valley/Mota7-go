export const STORES_CATEGORIES_DATA = {
  id: 'stores-root',
  nameAr: 'المتاجر',
  nameEn: 'Stores',
  icon: 'storefront',
  ...
  items: [
    ...
    { id: 'building_finishing', nameAr: 'مواد بناء، حدايد، وبويات', nameEn: 'Building & Finishing', icon: 'construction' },
    { id: 'automotive', nameAr: 'سيارات، موتوسيكلات، قطع غيار، وزيوت', nameEn: 'Automotive & Parts', icon: 'directions_car' },
    { id: 'general_stores', nameAr: 'خردوات، مكتبات، وهدايا', nameEn: 'Stationery & Gifts', icon: 'local_mall' },
  ],
};
